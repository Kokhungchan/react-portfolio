    ...
    <section id="about">
      <Container>
        ...
        <Row className="about-wrapper">
          <Col md={6} sm={12}>
            <Fade bottom duration={200} delay={100} distance="30px">
          ...
          <Col md={5} sm={12}>
            <Fade left={isDesktop} bottom={isMobile} duration={200} delay={100} distance="30px">
        ...
        <Row className="about-wrapper-icon">
            <Fade up={isDesktop} bottom={isMobile} duration={200} delay={100} distance="30px">
